...
--	pos = big_bubble(20, pos, "You might says:", "What the hell are these bubbles for?")
	pos = huge_bubble(20, pos, "Scenic_flyer STatus:", "Go and enjoy your flight!", "It will be easy to do this with me onboard.", "I will give you some tipps.")
end

do_every_draw("Flyer()")

--ScenicFlyer commands
----  /view
--	/view
--Commands are:-
----/view/scenic_flyer_on_off	Great on a joystick button, panel on/off !
